...
export declare const FIORI_FCL_ROUTER_CLASS = "sap.f.routing.Router";
export declare type RouterClass = typeof FIORI_FCL_ROUTER_CLASS | string;
...
export declare const SAPUI5_DEPENDENCY_LIB_SAP_F = "sap.f";
