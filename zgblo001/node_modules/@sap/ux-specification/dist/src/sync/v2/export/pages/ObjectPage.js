...
let ObjectPage = class ObjectPage {
};
__decorate([
...
], ObjectPage.prototype, "showConfirmationOnDraftActivate", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingOBJPathV2(pageKeys)
...
], ObjectPage.prototype, "hideChevronForUnauthorizedExtNav", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingOBJPathV2(pageKeys)
...
], ObjectPage.prototype, "allowDeepLinking", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (pageKeys) => application_1.getAppSettingOBJPathV2(pageKeys)
...
], ObjectPage.prototype, "navToListOnSave", void 0);
__decorate([
    decorators_1.childId('header')
], ObjectPage.prototype, "header", void 0);
__decorate([
    decorators_1.childId('sections')
], ObjectPage.prototype, "sections", void 0);
__decorate([
    decorators_1.childId('layout')
...
], ObjectPage.prototype, "globalChartSettings", void 0);
ObjectPage = __decorate([
    decorators_1.pageLayoutInformation({
        id: v2_1.SAPUI5_VIEW_EXTENSION_OBJECT_PAGE,
        pageId: v2_1.FE_TEMPLATE_V2_OBJECT_PAGE
    })
], ObjectPage);
