...
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (entitySet, sectionId) => application_1.getObjectPageCustomSectionPath(entitySet, sectionId),
            export: false,
            import: (manifest, sectionId) => {
...
], BaseCustomSection.prototype, "type", void 0);
__decorate([
    decorators_1.syncRule({
        manifest: {
            path: (entitySet, sectionId) => application_1.getObjectPageCustomSectionPath(entitySet, sectionId, 'sap.ui.generic.app')
        }
    }),
    decorators_1.validity({
        since: '1.52.0'
