...
*/
export declare type ConformanceLevel = EnumValue<ConformanceLevelType>;
...
*/
export declare type IsolationSupported = EnumValue<IsolationLevel>;
...
*/
export declare type CallbackType = ComplexType & {
...
export declare type CallbackProtocol = ComplexType & {
...
export declare type NavigationPropertyRestriction = ComplexType & {
...
export declare type FilterExpressionType = Edm.String;
/**
  Restrictions on orderby expressions
*/
...
export declare type PermissionType = ComplexType & {
...
export declare type ScopeType = ComplexType & {
...
*/
export declare type ReadByKeyRestrictionsType = ComplexType & Omit<ReadRestrictionsBase, "$Type"> & {
    $Type: CapabilitiesAnnotationTypes.ReadByKeyRestrictionsType;
};
export declare type ReadRestrictionsType = ComplexType & Omit<ReadRestrictionsBase, "$Type"> & {
...
*/
export declare type CustomParameter = ComplexType & {
