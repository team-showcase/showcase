...
/**
  Address book entry
*/
export type Contact = AnnotationTerm<ContactTypeTypes>;
...
/**
  Address
*/
export type Address = AnnotationTerm<AddressTypeTypes>;
...
/**
  Calendar entry
*/
export type Event = AnnotationTerm<EventDataTypes>;
...
/**
  Task list entry
*/
export type Task = AnnotationTerm<TaskDataTypes>;
...
/**
  Email message
*/
export type Message = AnnotationTerm<MessageDataTypes>;
...
export const enum CommunicationAnnotationTerms {
...
export const enum CommunicationAnnotationTypes {
...
export type ContactTypeTypes = AnnotationTerm<ContactType>;
export type NameTypeTypes = AnnotationTerm<NameType>;
export type AddressTypeTypes = AnnotationTerm<AddressType>;
export type PhoneNumberTypeTypes = AnnotationTerm<PhoneNumberType>;
export type EmailAddressTypeTypes = AnnotationTerm<EmailAddressType>;
export type GeoDataTypeTypes = AnnotationTerm<GeoDataType>;
export type UrlTypeTypes = AnnotationTerm<UrlType>;
export type EventDataTypes = AnnotationTerm<EventData>;
export type TaskDataTypes = AnnotationTerm<TaskData>;
export type MessageDataTypes = AnnotationTerm<MessageData>;
