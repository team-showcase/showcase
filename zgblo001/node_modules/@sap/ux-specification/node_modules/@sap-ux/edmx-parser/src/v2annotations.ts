import { Annotation, PropertyValue, UIAnnotationTerms } from "@sap-ux/vocabularies-types";
import { CoreAnnotationTerms } from "@sap-ux/vocabularies-types/dist/generated/Core";
import { CapabilitiesAnnotationTerms } from "@sap-ux/vocabularies-types/dist/generated/Capabilities";
import { CommonAnnotationTerms, FieldControlType } from "@sap-ux/vocabularies-types/dist/generated/Common";
import { MeasuresAnnotationTerms } from "@sap-ux/vocabularies-types/dist/generated/Measures";

export type V2Annotations = {
...
export type ObjectType = "EntitySet" | "Property" | "NavigationProperty";
export function convertV2Annotations(
	attributes: V2Annotations,
